...
typedef struct countersC {
	counters_t *counterA; //pointer to data for this node
	counters_t *counterB; //pointer to the key string (tag)
} countersC_t;


void counters_union_helper(int key, int data, void *arg);
void counters_union(countersC_t* c, counters_t* counter1);

void counters_intersection(countersC_t* h, counters_t* counter1);
void counters_intersection_helper(int key, int data, void *changedList);
