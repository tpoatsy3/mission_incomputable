...
// bool addPlayer(hashStruct *allGameInfo, char **messageArray, receiverAddr_t *addr){
...
// 		new->playerName = messageArray[4];
// 		new->teamName = messageArray[3];
// 		new->status = 0; //default is 0 (active)
// 		new->lat = messageArray[5];
// 		new->lng = messageArray[6];
// 		new->lastContact = time(NULL);
// 		new->addr = addr;

// 		hashtable_insert(allGameInfo->FA, messageArray[2], new);
// 	} else {
