...
void sendMultipleIterator(void* key, void* data, void* farg);
...
//send all
  ...
  sendingInfo_p->message = response;

  hash_iterate(hash, sendMultipleIterator, sendingInfo_p);
